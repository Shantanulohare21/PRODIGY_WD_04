...
import { Linkedin, Github, Twitter, MapPin, ExternalLink, Cpu } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="flex items-center gap-3 group cursor-pointer w-fit">
              ...
              <div>
                ...
                <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">{t.footer.subtitle}</span>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <h4 className="text-white font-black text-xs uppercase tracking-[0.4em] italic mb-8 flex items-center gap-3">
              <span className="w-8 h-px bg-teal-500/40"></span> {t.footer.directory}
            </h4>
          ...
          <div className="space-y-8">
            <h4 className="text-white font-black text-xs uppercase tracking-[0.4em] italic mb-8 flex items-center gap-3">
              <span className="w-8 h-px bg-teal-500/40"></span> {t.footer.connectivity}
            </h4>
            <div className="flex flex-col gap-6">
              <a href="mailto:shantanulohare021@gmail.com" className="group">
                <span className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1 group-hover:text-teal-400 transition-colors">{t.footer.directSignal}</span>
              ...
              <div className="group">
                <span className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">{t.footer.operationalBase}</span>
                <span className="text-white font-bold text-sm tracking-tight flex items-center gap-2">
                  {t.contact.location} <MapPin className="w-3 h-3 text-teal-500" />
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/5 border border-white/10">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">{t.footer.status}</span>
          </div>
        </div>
      </div>
    </footer>
