...
import { Code2, Monitor, Server, Database, Wrench, Layers, Lightbulb } from 'lucide-react';
...
const Skills = () => {
  ...
  const skillCategories = [
    { titleKey: 'Programming', icon: Code2, items: ['Java', 'JavaScript', 'Python', 'TypeScript'] },
    { titleKey: 'Frontend', icon: Monitor, items: ['React.js', 'Next.js', 'Tailwind CSS', 'Redux'] },
    { titleKey: 'Backend', icon: Server, items: ['Node.js', 'Express.js', 'FastAPI', 'Prisma'] },
    { titleKey: 'Databases', icon: Database, items: ['MongoDB', 'MySQL', 'PostgreSQL', 'Prisma'] },
    { titleKey: 'Tools & DevOps', icon: Wrench, items: ['Git', 'GitHub', 'Docker', 'Vercel'] },
    { titleKey: 'Stack Specialization', icon: Layers, items: ['MERN Stack Mastery', 'Full Stack Development'] },
    { titleKey: 'Core AI Concepts', icon: Lightbulb, items: ['Machine Learning', 'TensorFlow', 'Deep Learning', 'CNN/RNN'] },
  ];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col items-center mb-20 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 reveal-text tracking-tight leading-tight">{t.skills.title}</h2>
          ...
          {skillCategories.map((category, i) => (
            ...
            >
              <div className="flex items-center gap-5 mb-8 pb-4 border-b border-white/5 group-hover:border-teal-500/30 transition-all duration-300">
                ...
                <h3 className="text-white font-extrabold text-lg tracking-tight uppercase group-hover:text-teal-400 transition-colors">{category.titleKey}</h3>
              </div>
